...
$output .= '<div class="g-form-row for_username ' . $clru_validate['username_state'] . '">
...
$output .= '<div class="g-form-row-state">' . $clru_validate['username_exists_state'] . '</div>';
$output .= '</div>';

$output .= '<div class="g-form-row for_realname ' . $clru_validate['realname_state'] . '">
				<div class="g-form-field">
...
$output .= '<div class="g-form-row-state">' . $clru_validate['realname_valid_state'] . '</div>';
$output .= '</div>';
...
$output .= '<div class="g-form-row-state">' . $clru_validate['email_valid_state'] . '</div>';
$output .= '</div>';
...
$output .= '<div class="g-form-row for_password ' . $clru_validate['password2_state'] . '">
				<div class="g-form-field">
...
if ( $public_key != '' ) {
	$output .= '<div class="g-form-row for_recaptcha ' . $clru_validate['recaptcha_state'] . '">
					<div class="g-form-field">
						<div class="g-recaptcha" data-sitekey="' . $public_key . '"></div>
					</div>
					<div class="g-form-row-state">' . $clru_validate['recaptcha_valid_state'] . '</div>
				</div>';
}

$output .= '<div class="g-form-row for_agree ' . $clru_validate['agree_state'] . '">
				...
				<div class="g-form-row-state">' . $clru_validate['agree_valid_state'] . '</div>
			</div>';
